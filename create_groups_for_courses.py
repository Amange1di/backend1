...
import django
django.setup()
from core.models import User, Course, Company, Group, Student, Auditorium
...
for course_idx, course in enumerate(company_courses):
    ...
    for group_idx in range(groups_count):
        # Выбираем месяц
        month_name, month_start, month_end = months[group_idx % len(months)]
        ...
        # Название группы
        group_name = f"{course.title} - {month_name}"
